...
public class UtilAluno {
    ...
    public void listarAlunos() {
        if (alunos.isEmpty()) {
            ...
            for (Aluno aluno : alunos) {
                System.out.println("- Nome: " + aluno.getNome() + ", Matrícula: " + aluno.getMatricula() + ", Ano de Ingresso: " + aluno.getAnoIngresso());
            }
        }
    }
    ...
    public void listarAlunosPorDisciplina(String nomeDisciplina) {
        boolean found = false;
        for (Turma turma : UtilTurma.getInstance().getTurmas()) {
